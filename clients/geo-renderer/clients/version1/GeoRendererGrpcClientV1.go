...
func (c *GeoRendererGrpcClientV1) GetZones(ctx context.Context, reqctx rdata.RequestContextV1,
	filter *cquery.FilterParams,
	...
	response, err := c.CallCommand(ctx, "get_zones", cdata.NewAnyValueMapFromValue(params.Value()))
...
func (c *GeoRendererGrpcClientV1) GetZoneById(ctx context.Context, reqctx rdata.RequestContextV1,
...
func (c *GeoRendererGrpcClientV1) CreateZone(ctx context.Context, reqctx rdata.RequestContextV1,
...
func (c *GeoRendererGrpcClientV1) UpdateZone(ctx context.Context, reqctx rdata.RequestContextV1,
	zone data1.ZoneV1) (*data1.ZoneV1, error) {
...
func (c *GeoRendererGrpcClientV1) DeleteZoneById(ctx context.Context, reqctx rdata.RequestContextV1,
	id string) (*data1.ZoneV1, error) {
