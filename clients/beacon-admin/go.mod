module github.com/Shuv1Wolf/subterra-locate/clients/beacon-admin

go 1.24.4

require (
	github.com/Shuv1Wolf/subterra-locate/services/beacon-admin v0.0.0-20250719210857-eb91f12cb341
	...
	github.com/pip-services4/pip-services4-go/pip-services4-persistence-go v0.0.1-3
