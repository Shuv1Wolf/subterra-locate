...
func (c *NatsPublisher) SendDeviceDeletedEvent(ctx context.Context, id string) error {
	return c.sendDeviceEvent(ctx, id, natsConst.NATS_DEVICE_EVENTS_DELETED_TYPE)
}

func (c *NatsPublisher) SendDeviceChangedEvent(ctx context.Context, id string) error {
	return c.sendDeviceEvent(ctx, id, natsConst.NATS_DEVICE_EVENTS_CHANGED_TYPE)
}

func (c *NatsPublisher) SendDeviceCreatedEvent(ctx context.Context, id string) error {
	return c.sendDeviceEvent(ctx, id, natsConst.NATS_DEVICE_EVENTS_CREATED_TYPE)
}

func (c *NatsPublisher) sendDeviceEvent(ctx context.Context, id string, msgType string) error {
