...
type ZoneMemoryPersistence struct {
	cpersist.IdentifiableMemoryPersistence[data.ZoneV1, string]
}

func NewZoneMemoryPersistence() *ZoneMemoryPersistence {
	return &ZoneMemoryPersistence{
		IdentifiableMemoryPersistence: *cpersist.NewIdentifiableMemoryPersistence[data.ZoneV1, string](),
	}
}

func (c *ZoneMemoryPersistence) GetPageByFilter(ctx context.Context, reqctx cdata.RequestContextV1, filter cquery.FilterParams, paging cquery.PagingParams) (page cquery.DataPage[data.ZoneV1], err error) {
	if reqctx.OrgId != "" {
...
func (c *ZoneMemoryPersistence) GetOneById(ctx context.Context, reqctx cdata.RequestContextV1, id string) (data.ZoneV1, error) {
	item, err := c.IdentifiableMemoryPersistence.GetOneById(ctx, id)
	if err != nil || item.Id == "" {
		return item, err
	}
	if item.OrgId != reqctx.OrgId {
		return data.ZoneV1{}, nil
	}
	return item, nil
}

func (c *ZoneMemoryPersistence) Create(ctx context.Context, reqctx cdata.RequestContextV1, item data.ZoneV1) (data.ZoneV1, error) {
	if item.OrgId == "" {
...
func (c *ZoneMemoryPersistence) Update(ctx context.Context, reqctx cdata.RequestContextV1, item data.ZoneV1) (data.ZoneV1, error) {
...
func (c *ZoneMemoryPersistence) DeleteById(ctx context.Context, reqctx cdata.RequestContextV1, id string) (data.ZoneV1, error) {
...
func (c *ZoneMemoryPersistence) composeFilter(filter cquery.FilterParams) func(item data.ZoneV1) bool {
	...
	return func(item data.ZoneV1) bool {
		if idOk && item.Id != id {
			return false
		}
