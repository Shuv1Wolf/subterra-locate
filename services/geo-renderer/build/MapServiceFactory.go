...
func NewMapServiceFactory() *MapServiceFactory {
	...
	httpcontrollerV1Descriptor := cref.NewDescriptor("geo-renderer", "controller", "grpc", "*", "1.0")
	...
	c.RegisterType(httpcontrollerV1Descriptor, controllers.NewMapCommandableGrpcControllerV1)
