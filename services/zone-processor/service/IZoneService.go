...
type IZoneService interface {
	...
	GetZoneById(ctx context.Context, reqctx cdata.RequestContextV1, zone_id string) (data1.ZoneV1, error)
	...
	DeleteZoneById(ctx context.Context, reqctx cdata.RequestContextV1, zone_id string) (data1.ZoneV1, error)
}
