...
type MonitorZoneStreamEventV1_ZoneEventV1 struct {
	...
	Info          map[string]string      `protobuf:"bytes,12,rep,name=info,proto3" json:"info,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MonitorZoneStreamEventV1_ZoneEventV1) GetColor() string {
	if x != nil {
		return x.Color
	}
	return ""
...
const file_protos_monitor_proto_rawDesc = "" +
	...
	"\x06map_id\x18\x02 \x01(\tR\x05mapId\"\xa3\x04\n" +
	"\x18MonitorZoneStreamEventV1\x12Q\n" +
	"\x05event\x18\x01 \x03(\v2;.zone.processor.protos.MonitorZoneStreamEventV1.ZoneEventV1R\x05event\x1a\xb3\x03\n" +
	...
	"\adeleted\x18\n" +
	" \x01(\bR\adeleted\x12\x14\n" +
	"\x05color\x18\v \x01(\tR\x05color\x12Y\n" +
	"\x04info\x18\f \x03(\v2E.zone.processor.protos.MonitorZoneStreamEventV1.ZoneEventV1.InfoEntryR\x04info\x1a7\n" +
	"\tInfoEntry\x12\x10\n" +
