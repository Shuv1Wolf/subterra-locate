...
type ZonePostgresPersistenceTest struct {
	persistence *persistence.ZonePostgresPersistence
	fixture     *ZonePersistenceFixture
}

func newZonePostgresPersistenceTest() *ZonePostgresPersistenceTest {
	...
	persistence := persistence.NewZonePostgresPersistence()
	persistence.Configure(context.Background(), dbConfig)

	fixture := NewZonePersistenceFixture(persistence)

	return &ZonePostgresPersistenceTest{
		persistence: persistence,
		fixture:     fixture,
	}
}

func (c *ZonePostgresPersistenceTest) setup(t *testing.T) {
...
func (c *ZonePostgresPersistenceTest) teardown(t *testing.T) {
...
func TestZonePostgresPersistence(t *testing.T) {
	c := newZonePostgresPersistenceTest()
	if c == nil {
		return
	}
