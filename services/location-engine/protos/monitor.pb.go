...
const file_protos_monitor_proto_rawDesc = "" +
	"\n" +
	"\x14protos/monitor.proto\x12\x16location.engine.protos\"T\n" +
	"\x1eMonitorDeviceLocationRequestV1\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12\x1b\n" +
	"\tdevice_id\x18\x02 \x03(\tR\bdeviceId\"\xa5\x03\n" +
	"\"MonitorDeviceLocationStreamEventV1\x12`\n" +
	"\x05event\x18\x01 \x03(\v2J.location.engine.protos.MonitorDeviceLocationStreamEventV1.LocationEventV1R\x05event\x1a\x9c\x02\n" +
	...
	"\x01z\x18\x05 \x01(\x02R\x01z\x12h\n" +
	"\x04info\x18\x06 \x03(\v2T.location.engine.protos.MonitorDeviceLocationStreamEventV1.LocationEventV1.InfoEntryR\x04info\x1a7\n" +
	"\tInfoEntry\x12\x10\n" +
