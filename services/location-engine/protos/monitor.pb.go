...
type MonitorBeaconLocationRequestV1 struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	OrgId         string                 `protobuf:"bytes,1,opt,name=org_id,json=orgId,proto3" json:"org_id,omitempty"`
	MapId         string                 `protobuf:"bytes,2,opt,name=map_id,json=mapId,proto3" json:"map_id,omitempty"`
	BeaconId      []string               `protobuf:"bytes,3,rep,name=beacon_id,json=beaconId,proto3" json:"beacon_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *MonitorBeaconLocationRequestV1) Reset() {
	*x = MonitorBeaconLocationRequestV1{}
	mi := &file_protos_monitor_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MonitorBeaconLocationRequestV1) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MonitorBeaconLocationRequestV1) ProtoMessage() {}

func (x *MonitorBeaconLocationRequestV1) ProtoReflect() protoreflect.Message {
	mi := &file_protos_monitor_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MonitorBeaconLocationRequestV1.ProtoReflect.Descriptor instead.
func (*MonitorBeaconLocationRequestV1) Descriptor() ([]byte, []int) {
	return file_protos_monitor_proto_rawDescGZIP(), []int{2}
}

func (x *MonitorBeaconLocationRequestV1) GetOrgId() string {
	if x != nil {
		return x.OrgId
	}
	return ""
...
func (x *MonitorBeaconLocationRequestV1) GetMapId() string {
	if x != nil {
		return x.MapId
	}
	return ""
...
func (x *MonitorBeaconLocationRequestV1) GetBeaconId() []string {
	if x != nil {
		return x.BeaconId
	}
	return nil
...
type MonitorBeaconLocationStreamEventV1 struct {
	state         protoimpl.MessageState                                `protogen:"open.v1"`
	Event         []*MonitorBeaconLocationStreamEventV1_LocationEventV1 `protobuf:"bytes,1,rep,name=event,proto3" json:"event,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *MonitorBeaconLocationStreamEventV1) Reset() {
	*x = MonitorBeaconLocationStreamEventV1{}
	mi := &file_protos_monitor_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MonitorBeaconLocationStreamEventV1) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MonitorBeaconLocationStreamEventV1) ProtoMessage() {}

func (x *MonitorBeaconLocationStreamEventV1) ProtoReflect() protoreflect.Message {
	mi := &file_protos_monitor_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MonitorBeaconLocationStreamEventV1.ProtoReflect.Descriptor instead.
func (*MonitorBeaconLocationStreamEventV1) Descriptor() ([]byte, []int) {
	return file_protos_monitor_proto_rawDescGZIP(), []int{3}
}

func (x *MonitorBeaconLocationStreamEventV1) GetEvent() []*MonitorBeaconLocationStreamEventV1_LocationEventV1 {
	if x != nil {
		return x.Event
	}
	return nil
...
type MonitorBeaconLocationStreamEventV1_LocationEventV1 struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	BeaconId      string                 `protobuf:"bytes,1,opt,name=beacon_id,json=beaconId,proto3" json:"beacon_id,omitempty"`
	BeaconName    string                 `protobuf:"bytes,2,opt,name=beacon_name,json=beaconName,proto3" json:"beacon_name,omitempty"`
	MapId         string                 `protobuf:"bytes,3,opt,name=map_id,json=mapId,proto3" json:"map_id,omitempty"`
	X             float32                `protobuf:"fixed32,4,opt,name=x,proto3" json:"x,omitempty"`
	Y             float32                `protobuf:"fixed32,5,opt,name=y,proto3" json:"y,omitempty"`
	Z             float32                `protobuf:"fixed32,6,opt,name=z,proto3" json:"z,omitempty"`
...
func (x *MonitorBeaconLocationStreamEventV1_LocationEventV1) Reset() {
	*x = MonitorBeaconLocationStreamEventV1_LocationEventV1{}
	mi := &file_protos_monitor_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MonitorBeaconLocationStreamEventV1_LocationEventV1) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MonitorBeaconLocationStreamEventV1_LocationEventV1) ProtoMessage() {}

func (x *MonitorBeaconLocationStreamEventV1_LocationEventV1) ProtoReflect() protoreflect.Message {
	mi := &file_protos_monitor_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MonitorBeaconLocationStreamEventV1_LocationEventV1.ProtoReflect.Descriptor instead.
func (*MonitorBeaconLocationStreamEventV1_LocationEventV1) Descriptor() ([]byte, []int) {
	return file_protos_monitor_proto_rawDescGZIP(), []int{3, 0}
}

func (x *MonitorBeaconLocationStreamEventV1_LocationEventV1) GetBeaconId() string {
	if x != nil {
		return x.BeaconId
	}
	return ""
...
func (x *MonitorBeaconLocationStreamEventV1_LocationEventV1) GetBeaconName() string {
	if x != nil {
		return x.BeaconName
	}
	return ""
...
func (x *MonitorBeaconLocationStreamEventV1_LocationEventV1) GetMapId() string {
	if x != nil {
		return x.MapId
	}
	return ""
...
func (x *MonitorBeaconLocationStreamEventV1_LocationEventV1) GetX() float32 {
	if x != nil {
		return x.X
	}
	return 0
...
func (x *MonitorBeaconLocationStreamEventV1_LocationEventV1) GetY() float32 {
	if x != nil {
		return x.Y
	}
	return 0
...
func (x *MonitorBeaconLocationStreamEventV1_LocationEventV1) GetZ() float32 {
	if x != nil {
		return x.Z
	}
	return 0
...
func (x *MonitorBeaconLocationStreamEventV1_LocationEventV1) GetInfo() map[string]string {
	if x != nil {
		return x.Info
	}
	return nil
...
const file_protos_monitor_proto_rawDesc = "" +
	...
	"\x1eMonitorBeaconLocationRequestV1\x12\x15\n" +
	"\x06org_id\x18\x01 \x01(\tR\x05orgId\x12\x15\n" +
	"\x06map_id\x18\x02 \x01(\tR\x05mapId\x12\x1b\n" +
	"\tbeacon_id\x18\x03 \x03(\tR\bbeaconId\"\xbc\x03\n" +
	"\"MonitorBeaconLocationStreamEventV1\x12`\n" +
	"\x05event\x18\x01 \x03(\v2J.location.engine.protos.MonitorBeaconLocationStreamEventV1.LocationEventV1R\x05event\x1a\xb3\x02\n" +
	"\x0fLocationEventV1\x12\x1b\n" +
	"\tbeacon_id\x18\x01 \x01(\tR\bbeaconId\x12\x1f\n" +
	"\vbeacon_name\x18\x02 \x01(\tR\n" +
	"beaconName\x12\x15\n" +
	"\x06map_id\x18\x03 \x01(\tR\x05mapId\x12\f\n" +
	"\x01x\x18\x04 \x01(\x02R\x01x\x12\f\n" +
	"\x01y\x18\x05 \x01(\x02R\x01y\x12\f\n" +
	"\x01z\x18\x06 \x01(\x02R\x01z\x12h\n" +
	"\x04info\x18\a \x03(\v2T.location.engine.protos.MonitorBeaconLocationStreamEventV1.LocationEventV1.InfoEntryR\x04info\x1a7\n" +
	"\tInfoEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x012\xb9\x02\n" +
	"\x0fLocationMonitor\x12\x91\x01\n" +
	"\x17MonitorDeviceLocationV1\x126.location.engine.protos.MonitorDeviceLocationRequestV1\x1a:.location.engine.protos.MonitorDeviceLocationStreamEventV1\"\x000\x01\x12\x91\x01\n" +
	"\x17MonitorBeaconLocationV1\x126.location.engine.protos.MonitorBeaconLocationRequestV1\x1a:.location.engine.protos.MonitorBeaconLocationStreamEventV1\"\x000\x01BFZDgithub.com/Shuv1Wolf/subterra-locate/services/location-engine/protosb\x06proto3"
...
var file_protos_monitor_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_protos_monitor_proto_goTypes = []any{
	...
	(*MonitorBeaconLocationRequestV1)(nil),                     // 2: location.engine.protos.MonitorBeaconLocationRequestV1
	(*MonitorBeaconLocationStreamEventV1)(nil),                 // 3: location.engine.protos.MonitorBeaconLocationStreamEventV1
	(*MonitorDeviceLocationStreamEventV1_LocationEventV1)(nil), // 4: location.engine.protos.MonitorDeviceLocationStreamEventV1.LocationEventV1
	nil, // 5: location.engine.protos.MonitorDeviceLocationStreamEventV1.LocationEventV1.InfoEntry
	(*MonitorBeaconLocationStreamEventV1_LocationEventV1)(nil), // 6: location.engine.protos.MonitorBeaconLocationStreamEventV1.LocationEventV1
	nil, // 7: location.engine.protos.MonitorBeaconLocationStreamEventV1.LocationEventV1.InfoEntry
}
var file_protos_monitor_proto_depIdxs = []int32{
	4, // 0: location.engine.protos.MonitorDeviceLocationStreamEventV1.event:type_name -> location.engine.protos.MonitorDeviceLocationStreamEventV1.LocationEventV1
	6, // 1: location.engine.protos.MonitorBeaconLocationStreamEventV1.event:type_name -> location.engine.protos.MonitorBeaconLocationStreamEventV1.LocationEventV1
	5, // 2: location.engine.protos.MonitorDeviceLocationStreamEventV1.LocationEventV1.info:type_name -> location.engine.protos.MonitorDeviceLocationStreamEventV1.LocationEventV1.InfoEntry
	7, // 3: location.engine.protos.MonitorBeaconLocationStreamEventV1.LocationEventV1.info:type_name -> location.engine.protos.MonitorBeaconLocationStreamEventV1.LocationEventV1.InfoEntry
	0, // 4: location.engine.protos.LocationMonitor.MonitorDeviceLocationV1:input_type -> location.engine.protos.MonitorDeviceLocationRequestV1
	2, // 5: location.engine.protos.LocationMonitor.MonitorBeaconLocationV1:input_type -> location.engine.protos.MonitorBeaconLocationRequestV1
	1, // 6: location.engine.protos.LocationMonitor.MonitorDeviceLocationV1:output_type -> location.engine.protos.MonitorDeviceLocationStreamEventV1
	3, // 7: location.engine.protos.LocationMonitor.MonitorBeaconLocationV1:output_type -> location.engine.protos.MonitorBeaconLocationStreamEventV1
