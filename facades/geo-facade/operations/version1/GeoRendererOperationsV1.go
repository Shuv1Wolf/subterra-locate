...
func (c *GeoRendererOperationsV1) GetZones(res http.ResponseWriter, req *http.Request) {
	var filter = c.GetFilterParams(req)
	var paging = c.GetPagingParams(req)

	reqctx := cdata.GetRequestContextParams(req)

	page, err := c.geoRenderer.GetZones(
		context.Background(), *reqctx, filter, paging)
...
func (c *GeoRendererOperationsV1) GetZoneById(res http.ResponseWriter, req *http.Request) {
	id := c.GetParam(req, "id")
	reqctx := cdata.GetRequestContextParams(req)

	item, err := c.geoRenderer.GetZoneById(context.Background(), *reqctx, id)
	if err != nil {
		c.SendError(res, req, err)
	} else {
		c.SendResult(res, req, item, nil)
...
func (c *GeoRendererOperationsV1) CreateZone(res http.ResponseWriter, req *http.Request) {
	reqctx := cdata.GetRequestContextParams(req)

	data := services1.ZoneV1{}
	err := c.DecodeBody(req, &data)
	if err != nil {
		c.SendError(res, req, err)
	}
	data.CreatedAt = time.Now()
	item, err := c.geoRenderer.CreateZone(context.Background(), *reqctx, data)
	if err != nil {
		c.SendError(res, req, err)
	} else {
		c.SendResult(res, req, item, nil)
...
func (c *GeoRendererOperationsV1) UpdateZone(res http.ResponseWriter, req *http.Request) {
	reqctx := cdata.GetRequestContextParams(req)
	...
	item, err := c.geoRenderer.UpdateZone(context.Background(), *reqctx, data)
	if err != nil {
		c.SendError(res, req, err)
	} else {
		c.SendResult(res, req, item, nil)
...
func (c *GeoRendererOperationsV1) DeleteZoneById(res http.ResponseWriter, req *http.Request) {
	id := c.GetParam(req, "id")
	reqctx := cdata.GetRequestContextParams(req)

	item, err := c.geoRenderer.DeleteZoneById(context.Background(), *reqctx, id)
