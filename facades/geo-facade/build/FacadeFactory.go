...
import (
	controllers1 "github.com/Shuv1Wolf/subterra-locate/facades/geo-facade/controllers/version1"
...
func NewFacadeFactory() *FacadeFactory {
	...
	c.FacadeServiceV1Descriptor = cref.NewDescriptor("geo-facade", "controller", "http", "*", "1.0")
